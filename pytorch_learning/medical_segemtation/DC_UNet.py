...
class ConvBlock(nn.Module):
    ...
    def __init__(self,
        ...
        self.bn = nn.GroupNorm(output_channels, output_channels)
...
class DcBlock(nn.Module):
    ...
    def __init__(self,
        ...
        self.bn = nn.GroupNorm(self.output_channels, self.output_channels)
...
class ResPath(nn.Module):
    ...
    def __init__(self,
        ...
        self.bn = nn.GroupNorm(self.conv2.output_channels, self.conv2.output_channels)
