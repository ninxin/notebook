...
class UNet(nn.Module):
    def __init__(self, n_channels, n_classes, out_channels=32):
        ...
        self.down4 = Down(12, 12)
        self.up1 = Up(12, 12, bilinear)
        self.up2 = Up(12, 12, bilinear)
        self.up3 = Up(12, 20, bilinear)
        self.up4 = Up(20, out_channels, bilinear)
...
class MiniUNet(nn.Module):
    def __init__(self, n_channels, n_classes, out_channels=32):
        ...
        self.down3 = Down(12, 12)
        self.up1 = Up(12, 12, bilinear)
        self.up2 = Up(12, 20, bilinear)
        self.up3 = Up(20, out_channels, bilinear)
        self.outc = OutConv(out_channels, n_classes)
