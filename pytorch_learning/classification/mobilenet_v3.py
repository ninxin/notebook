...
class SqueezeExcitaion(nn.Module):
    def __init__(self, input_c: int, squeeze_factor: int = 4):
        ...
        self.fc1 = nn.Conv2d(input_c, squeeze_c, 1)         # 1X1卷积相当于全链接
...
class InvertedResidual(nn.Module):
    def __init__(self,
        ...
        if cnf.stride not in [1, 2]:
            raise ValueError("illegal strode value.")
...
class MobileNetV3(nn.Module):
    def __init__(self,
        ...
        if not inverted_residual_setting:
            ...
            raise TypeError("the inverted_residual_setting should be List[InveredResdualConfig")
...
def mobilenet_v3_small(num_classes: int = 1000,
    ...
    inverted_residual_setting = [
        ...
        bneck_conf(148, 5, 288, 96 // reduce_divider, True, "HS", 2),
