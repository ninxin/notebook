...
def main():
    ...
    for cla in dataclass:
        ...
        num = len(images)
        # 随机采样验证集的索引
        eval_index = random.sample(images, k=1)      # int(num*split_rate)
